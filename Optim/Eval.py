...
################################################################################
# Usage shortcut:
# xvfb-run python /home/rayhub-user/Optim-WaLa/Optim/Eval.py   --metric lfd   --folder_a ~/Google_Dataset_Objects   --folder_b ~/Original_Model_Objects   --s3_bucket_a giuliaa-optim   --s3_prefix_a /Google_Dataset_Objects/   --s3_bucket_b giuliaa-optim   --s3_prefix_b /Original_Model_Objects/    --verbose   --no-rotate   --comet
