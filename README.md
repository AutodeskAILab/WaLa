...
| Object Name | Input Image                               | Original (WaLa)         | Optimized (WaLa + TensorRT)    |
|-------------|-------------------------------------------|-------------------------|--------------------------------|
| `apple`     | ![](examples/single_view/apple.jpeg)      | ![](figures/apple.gif)  | ![](examples/figures/chair_trt.gif) |
| `table`     | ![](examples/single_view/table.png)       | ![](examples/figures/table.gif) | ![](examples/figures/table_trt.gif) |
| `lamp`      | ![](examples/single_view/pitcher.jpeg)      | ![](figures/pitcher.gif) | ![](figures/pitcher_trt.gif)     |
