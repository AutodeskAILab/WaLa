...
class General_Decoder_Up_1(nn.Module):
    def __init__(
        self,
        channel_in,
        channel_out,
...
class General_Encoder_Down_3(nn.Module):
    def __init__(
        self,
        channel_in,
        channel_out,
        ...
        self.down_3 = Downsample(hidden_channel, False, dims=3)
        self.res_4 = ResBlock(
            hidden_channel, dropout, out_channels=hidden_channel, dims=3
        )
        self.res_4_1 = ResBlock(
            hidden_channel, dropout, out_channels=hidden_channel, dims=3
        )
...
class General_Decoder_Up_3(nn.Module):
    def __init__(
        self,
        channel_in,
        channel_out,
        ...
        self.up_3 = Upsample(hidden_channel, use_conv=False, dims=3)
        self.res_4 = ResBlock(
            hidden_channel, dropout, out_channels=hidden_channel, dims=3
        )
        self.res_4_1 = ResBlock(
